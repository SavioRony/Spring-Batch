package br.com.batch.estudobatch;
...
public class ParImparBatchConfig {
    ...
    private Step imprimeParImparStep() {
        return stepBuilderFactory
                ...
                .<Integer, String> chunk(1) // Chunk sizer seria o commit intervalo que significa a quantidade de dados que vai processor por vez.
    ...
    private FunctionItemProcessor<Integer, String> parOuImparProcessor() {
        return new FunctionItemProcessor<Integer, String>
                (item -> item % 2 == 0 ? String.format("Item %s e Par", item)
                        : String.format("Item %s e Impar", item));
    }
